...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/alert-dialog#alertdialog" text="Animate UI API Reference - Alert Dialog Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/alert-dialog#alertdialogtrigger" text="Animate UI API Reference - Dialog Trigger Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/alert-dialog#alertdialogcontent" text="Animate UI API Reference - Alert Dialog Content Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/alert-dialog#alertdialogcancel" text="Animate UI API Reference - Alert Dialog Cancel Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/alert-dialog#alertdialogtitle" text="Animate UI API Reference - Alert Dialog Title Primitive" />
...
<div className="flex flex-col gap-2">
  <ExternalLink href="https://animate-ui.com/docs/primitives/radix/alert-dialog#alertdialogdescription" text="Animate UI API Reference - Alert Dialog Description Primitive" />
