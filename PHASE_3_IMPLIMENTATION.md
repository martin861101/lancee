...
- Services page will have the already connected custom MCP services listed (Playwright, Websearches, Research, Other)
- Platform chat widget with AI integration that has access to platform data securely to answer questions on data and platform actions (Postgresql MCP server may be added if this simplifies things: https://github.com/antonorlov/mcp-postgres-server)
