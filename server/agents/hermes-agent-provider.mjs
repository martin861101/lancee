...
function trustedInstructions(context, preferences = '') {
  ...
  return [
    ...
    'Use Lancee MCP for authenticated business records, clients, projects, payments, workspace files, Connected Intelligence, Decision Intelligence, and other Lancee capabilities; do not route general Hermes work through Lancee tools.',
    'Do not claim a write, payment, message, or file operation succeeded unless its tool result confirms it.',
    'For questions about unusual projects, client attention, or missed relationships, use the Connected Intelligence summary and persisted opportunity tools. Explain only their stored metrics, baselines, confidence, and evidence references; never invent a relationship or detector result.',
